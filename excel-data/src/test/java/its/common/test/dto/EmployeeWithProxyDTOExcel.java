...
import its.common.service.impl.excel.ExcelDataReadProxy;
import lombok.Data;
...
public  class EmployeeWithProxyDTOExcel implements ExcelDataReadProxy<EmployeeWithProxyDTOExcel> {
    ...
    @Override
    public EmployeeWithProxyDTOExcel afterRowRead(EmployeeWithProxyDTOExcel o, AnalysisContext analysisContext){
        o.setAge(100);
        return o;
    }
}
